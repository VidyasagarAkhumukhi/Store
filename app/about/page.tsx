  ...
  return (
    <section>
      ...
      <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
        Lets be honest: online shopping can be a hassle. Between endless
        ...
        a better way. <br />
        That is why we created NextStore. <br />
        We are not just another online retailer. We are a team of product
        ...
        work of sourcing and testing so you do not have to. <br />
        <br />
        Here is our promise to you: <br />
        - Expertly Vetted: If it is here, it is one of the best. <br />
        - Effortless Discovery: Find what you need, and discover what you will
        love. <br />
